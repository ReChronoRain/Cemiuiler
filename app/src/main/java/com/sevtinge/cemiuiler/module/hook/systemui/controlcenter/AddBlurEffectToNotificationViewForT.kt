package com.sevtinge.cemiuiler.module.hook.systemui.controlcenter
 ...
 object AddBlurEffectToNotificationViewForT : BaseHook() { 
                 ...
                 override fun afterHookedMethod(param: MethodHookParam) { 
                     ...
                     val mPanelViewController = 
                         HookUtils.getValueByField(mController, "mPanelViewController") 
                             ?: return 
                     val isExpanding = 
                         XposedHelpers.callMethod(mPanelViewController,"isExpanding" 
                         ) as Boolean 
...
*/  
     ...
     fun isDefaultLockScreenTheme(): Boolean { 
         val miuiKeyguardUtilsClass = findClassIfExists("com.android.keyguard.utils.MiuiKeyguardUtils" 
         ) ?: return true 
         return XposedHelpers.callStaticMethod( 
